...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6491440242:AAEFblXhOx1g9LH-EPU4ej-oSFwUkyJrUw8") 
...
BOT_USERNAME = os.environ.get("BOT_USERNAME","MissAnushkabot") 
...
BOT_NAME = os.environ.get("BOT_NAME","MissAnushka")
